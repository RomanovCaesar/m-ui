(() => {
  ...
  if (!action) {
    ...
    action.innerHTML = '<span class="general-icon">'+AI('retweet')+'</span><span class="general-text" data-i18n="cs.menu">Export All Subscriptions (Cross Panel)</span>';
